---
name: agentfarm
description: "Use when the user asks to build a feature, fix a bug, or run any multi-step development task. Orchestrates a pipeline of AI agents (plan → develop → verify → test → review) automatically."
compatibility: "crush,opencode"
---
...
```bash
cd ~/agentfarm  # or wherever cloned
npm install
npm run build
npm link
agentfarm init
